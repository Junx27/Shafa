  ...
  return (
    <div className="">
      ...
      <div className="mt-20 md:mt-16 md:ms-80 md:pl-6 mx-5 md:mx-0 md:mr-10">
        <div className="p-5 border shadow rounded">
          ...
          <div className="grid md:grid-cols-4 gap-16 mt-5 mb-10">
            <div
              className="bg-orange-200 border transition-all duration-1000 p-5 rounded-lg shadow-md cursor-pointer hover:shadow-lg"
            ...
            <div
              className="bg-green-200 border transition-all duration-1000 p-5 rounded-lg shadow-md cursor-pointer hover:shadow-lg -mt-10 md:mt-0"
            ...
            <div
              className="bg-purple-200 border transition-all duration-1000 p-5 rounded-lg shadow-md cursor-pointer hover:shadow-lg -mt-10 md:mt-0"
            ...
            <div
              className="bg-red-200 border transition-all duration-1000 p-5 rounded-lg shadow-md cursor-pointer hover:shadow-lg -mt-10 md:mt-0"
      ...
      <div className="grid md:grid-cols-2 md:gap-20 mt-5 md:ms-80 md:pl-6 md:mr-10 mx-5 md:mx-0 mb-10">
        <div className="p-5 border shadow rounded mb-5 md:mb-0">
          <div className="text-xs flex bg-green-400 p-2 rounded w-64 shadow">
