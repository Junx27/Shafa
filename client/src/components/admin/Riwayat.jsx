    ...
    <div>
      {loading ? (
        ...
        <animated.div style={animation}>
          ...
          0 ? (
            <div className="mt-20">
              <div className="text-[10px] md:text-xs flex bg-red-400 p-2 rounded md:w-64 shadow items-center">
                ...
                {riwayat
                  ...
                  .map((row, index) => (
                    ...
                    >
                      ...
                      <span
                        className="text-sm text-end hover:text-red-400 cursor-pointer material-symbols-outlined"
                        onClick={() =>
                      ...
                      <span
                        className="text-sm text-end absolute md:relative md:top-0 md:right-0 top-4 right-4 hover:text-green-400 cursor-pointer material-symbols-outlined"
          ...
          {riwayat.filter(
            ...
            <div className="mt-10">
              <div className="text-[10px] md:text-xs flex bg-sky-400 p-2 rounded md:w-64 shadow items-center">
                <span className="text-[15px] md:text-xs material-symbols-outlined">
                  check
                </span>
                    ...
                    >
                      ...
                      <div onClick={() => setOpenItem(index)}>
                        <img
                          src={menu}
                          alt=""
                          className="w-5 absolute right-3 bottom-4 md:relative md:bottom-0 md:right-0"
                        />
                      </div>
                      {openItem === index && (
                        <div
