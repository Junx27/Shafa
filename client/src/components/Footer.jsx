...
function Footer() {
  ...
  return (
    <div className="px-10 md:px-32 py-8 bg-lime-400 rounded-t-[30px] text-xs">
      <div className="md:hidden">
        ...
        <div className="mx-auto">
          {openNavigasi && (
            <PopOver>
              <div className="absolute bottom-0 left-0 bg-lime-400 w-[500px] p-10">
                <p
                  onClick={() => setOpenNavigasi(!openNavigasi)}
          ...
          {openKontak && (
            <PopOver>
              <div className="absolute bottom-0 left-0 bg-lime-400 w-[500px] p-10">
                ...
                <ul
                  className={`${openKontak ? "visible" : "hidden md:visible"}`}
                >
          ...
          {openKritik && (
            <PopOver>
              <div className="absolute bottom-0 left-0 bg-lime-400 w-[500px] p-10">
                ...
                <form
                  onSubmit={saveKritik}
                  className={`${openKritik ? "visible" : "hidden md:visible "}`}
                >
                  <textarea
                    className="w-[320px] h-[200px] p-2 border border-lime-400 rounded-lg outline-none shadow mt-5"
                    value={kritik}
                    maxLength={255}
